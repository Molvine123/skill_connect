        ...
        <nav class="sidebar-nav">
            @auth
                ...
                @elseif(auth()->user()->isOrganization())
                    ...
                    <a href="{{ route('organization.attendance') }}" class="nav-item {{ request()->routeIs('organization.attendance*') ? 'active' : '' }}"><svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg> Attendance</a>
                    <a href="{{ route('organization.certificates.index') }}" class="nav-item {{ request()->routeIs('organization.certificates.index') ? 'active' : '' }}"><svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z"/></svg> Certificates</a>
                    <span class="nav-section-label">Settings</span>
